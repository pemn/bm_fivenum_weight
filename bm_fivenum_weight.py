#!python
# run fivenum weighted statistics (min,mean,max,std,var) on database
...
"""
usage: $0 input*bmf,csv,xlsx,isis,00t,00g,msh,dm condition lito:input weight:input variables#variable:input output*csv,xlsx keep_null@
"""
