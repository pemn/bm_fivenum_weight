...
'''
usage: $0 input*bmf,csv,xlsx,json,isis,dm,tif,tiff,00t,obj condition variables#variable:input#type=breakdown,count,sum,mean,min,max,var,std,sem,q1,q2,q3,p10,p90,major,list,text#weight:input keep_null@ output*csv,xlsx
'''
'''
